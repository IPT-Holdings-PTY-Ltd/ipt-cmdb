...
class MigrationTests(unittest.TestCase):
    def test_plan_is_ordered_and_latest_version_is_incremental_migration(self):
        ...
        self.assertEqual([item.version for item in plan], ["2026.07.13.1", "2026.07.15.1", "2026.07.15.2", "2026.07.15.3"])
        self.assertEqual(latest_schema_version(ROOT), "2026.07.15.3")
    ...
    def test_migrations_apply_once_and_reject_checksum_drift(self):
        ...
        self.assertEqual(apply_migrations(factory, ROOT), ["2026.07.13.1", "2026.07.15.1", "2026.07.15.2", "2026.07.15.3"])
