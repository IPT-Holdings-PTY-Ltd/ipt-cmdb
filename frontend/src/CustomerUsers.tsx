...
export function CustomerUsersPage() {
  ...
  return <Box>
    ...
    <Typography color="text.secondary" sx={{ mt: 0.75, mb: 3, maxWidth: 800 }}>
      ...
      <Grid size={{ xs: 12, xl: 5 }}>
        <Card><CardContent>
          <Stack component="form" spacing={2} onSubmit={createCustomerUser}>
            <Box><Typography variant="h5">Add customer user</Typography><Typography color="text.secondary">The account is permanently scoped to this selected customer.</Typography></Box>
      ...
      <Grid size={{ xs: 12, xl: 7 }}>
        <Stack spacing={3}>
          <Card><CardContent>
            ...
            <Typography color="text.secondary" sx={{ mb: 2 }}>Includes MSP operators and platform administrators who can enter this customer workspace.</Typography>
          ...
          <Card><CardContent>
            <Stack direction="row" spacing={1.5} alignItems="center"><SecurityOutlined color="primary" /><Typography variant="h5">Customer reader permissions</Typography></Stack>
